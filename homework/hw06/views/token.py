...
class AccessTokenEndpoint(Resource):
    ...
    def post(self):
        ...
        # 1. query database for user matching username
        #     if user doesnt exist, throw error
        # 2. check password matches
        #     if password doesnt exist, throw error
        # 3. user gets access code and refresh if matches
        ...
        # 3. Create access and refresh tokens which will embed logged in user's user_id (the_user.id)
