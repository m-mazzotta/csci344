...
# poetry run python run_tests.py TestPostListEndpoint -v    #OK
# poetry run python run_tests.py TestPostDetailEndpoint -v  #OK
# poetry run python run_tests.py TestBookmarkDetailEndpoint -v #OK
# poetry run python run_tests.py TestBookmarkListEndpoint -v   #OK
# poetry run python run_tests.py TestLikePostDetailEndpoint -v #OK
# poetry run python run_tests.py TestLikePostListEndpoint -v  #OK
# poetry run python run_tests.py TestProfileEndpoint -v #OK
# poetry run python run_tests.py TestStoryListEndpoint -v #OK
